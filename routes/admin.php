...
Route::middleware('admin')->group(function () {
    ...
    // Game
    Route::controller('GameController')->name('service.')->prefix('service')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('chance-create', 'chanceCreate')->name('chance.create');
        Route::get('service-log', 'gameLog')->name('log');
    });
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('user-type', 'userType')->name('user-type');
