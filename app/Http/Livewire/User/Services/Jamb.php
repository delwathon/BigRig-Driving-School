...
class Jamb extends Component
{
    ...
    public function updatedProfileCode($card){
        $this->profile_code = $card;
    ...
    public function submit()
    {
        $this->validate(
            [
                ...
                'profile_code' => 'required|digits_between:10,15',
        ...
        $transactions = transactions(auth()->user(), $this->final_amount, $this->service->id,$this->transaction_pin, $this->profile_code);
        ...
        try {
            ...
            // $this->plan =null;
                ...
                $this->reset(['network', 'amount', 'type', 'profile_code']);
    ...
    public function mount($service)
    {
        ...
        $this->types  = ['jamb'=>'Registration PIN', 'check-result'=>'Result Checker PIN'];
        $this->type ="";
        // $this->profile_code =  auth()->user()->mobile;
       
    }
    public function render()
    {
        return view('livewire.user.services.jamb');
    }
}
