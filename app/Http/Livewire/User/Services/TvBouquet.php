...
class TvBouquet extends Component
{
    public $network;
    public $networks = [];
    ...
    public function updatedNetwork($net){
        ...
        try {
            $response = $client->get('https://api-service.vtpass.com/api/service-variations?serviceID='.$this->network, [
                'headers' => [
            ...
            if (array_key_exists('errors', $tData)){
                // return $tData;
                $this->addError('general_error', "Error Occur when check the network data, kindly retry again");
    ...
    public function updatedSmartcardNumber($card){
        $this->smartcard_number = $card;
        ...
        try {
            $response = $client->post('https://api-service.vtpass.com/api/merchant-verify', [
                ...
                'body' => json_encode([
                    ...
                    'billersCode' => $this->smartcard_number,
    ...
    public function submit()
    {
        $this->validate(
            [
                ...
                'smartcard_number' => 'required|digits_between:10,15',
        ...
        $transactions = transactions(auth()->user(), $this->final_amount, $this->service->id,$this->transaction_pin, $this->smartcard_number);
    ...
    public function mount($service)
    {
        ...
        $this->networks = ['dstv' => 'DSTV', 'gotv' => 'GoTv', 'startimes' => 'Startimes', 'showmax' => 'Showmax'];
       
    }

    public function render()
    {
        return view('livewire.user.services.tv-bouquet');
    }
}
