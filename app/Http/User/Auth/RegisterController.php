...
class RegisterController extends Controller {
    ...
    public function register(Request $request) {
        ...
        // if (preg_match("/[^a-z0-9_]/", trim($request->username))) {
            ...
            $notify[] = ['info', 'Username can contain only small letters, numbers and underscore vboy.'];
        ...
        $exist = User::WhereNotNull('mobile')->where('mobile', $request->mobile_code . $request->mobile)->first();

        if ($exist && $request->mobile_code && $request->mobile) {
