...
class FrontendController extends Controller {
    ...
    public function templates() {
        $pageTitle = 'Templates';
        // return resource_path('views/templates');'resources/views/templates/*'
        ...
        foreach ($temPaths as $key => $temp) {
            ...
            $templates[$key]['image'] =  asset("assets/templates/$tempname/preview.jpg"); //asset($tempname) . '/preview.jpg';
        }
