        ...
        <div class="row gy-4">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                    ...
                    <a class="widget-two__btn" href="{{ route('admin.service.log') }}?search={{ $user->username }}">@lang('View All')</a>
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--success">
                    ...
                    <a class="widget-two__btn" href="{{ route('admin.service.log') }}?search={{ $user->username }}&win_status=1">@lang('View All')</a>
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--danger">
                    ...
                    <a class="widget-two__btn" href="{{ route('admin.service.log') }}?search={{ $user->username }}&win_status=2">@lang('View All')</a>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @php
                                $hash = json_decode($user->txHash);
                            @endphp

                            @foreach ($hash as $key =>$wallet)
                                <h3>{{ ucwords($key) }} : {{ $wallet }}</h3>
                            @endforeach
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('admin.deposit.verifypayment', $user->id) }}" class="btn btn--danger">Verify</a>
                        </div>

                        @else
                        <h3 class="btn btn-success btn-rounded">Verified</h3>
                         @endif
                    </div>
                </div>
            </div> --}}
