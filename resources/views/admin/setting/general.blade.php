                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label> @lang('Contact Email Address')</label>
                                    <input class="form-control" name="email" type="text" value="{{ $general->email }}" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Contact Phone')</label>
                                    <input class="form-control" name="phone" type="tel" value="{{ $general->phone }}" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Mobile Number')</label>
                                    <input class="form-control" name="mobile" type="tel" value="{{ $general->mobile }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2 col-sm-6">
                                <label> @lang('Primary Color')</label>
