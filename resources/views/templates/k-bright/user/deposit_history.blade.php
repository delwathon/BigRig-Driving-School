                    ...
                    <form action="">
                        <div class="d-flex justify-content-end ms-auto table--form mb- mb-3 flex-wrap">
                            <div class="input-group">
                                <input class="input-field form-control" name="search" type="text" value="{{ request()->search }}" placeholder="@lang('Search by transactions')">
                                    ...
                                    <tbody>
                                        @forelse($deposits as $deposit)
                                            <tr class="pricing">
                                                ...
                                                <td>
                                                    <div>
                                                        1 {{ __($general->cur_text) }} = {{ __($deposit->method_currency) }} {{ showAmount($deposit->rate) }} 
                                                        <br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content section--bg">
                <div class="modal-header">
                    ...
                    <span class="close" data-dismiss="modal" type="button" aria-label="Close">
