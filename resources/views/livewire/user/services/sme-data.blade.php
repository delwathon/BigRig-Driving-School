<div class="login-card">
    ...
    <form id="game" wire:submit.prevent="submit">
        ...
        <div class="form-group">
            <label for="inputNoncorehub">@lang('Type')</label>
            <select id="inputNoncorehub" class="form-control select-option" wire:model="type" required>
                <option value="">@lang('Select One')</option>
        ...
        <div class="form-group">
            ...
            <select id="inputNoncorehub" class="form-control select-option" wire:model="plan" required>
                <option value="">@lang('Select One')</option>
                @foreach ($plans as $pl)
                    <option value="{{ $pl['planId'] }}" >{{ str_replace("_"," ",$pl['name']) }} {{ $pl['allowance']}} {{$pl['validity']}}
                    </option>
                @endforeach
            </select>
        </div>
