<div class="login-card">
    ...
    <form id="game" wire:submit.prevent="submit">
        ...
        <div class="form-group">
            <label for="exampleInputEmail1"> @lang('Username Or Account Number')</label>
            <input class="input-field form-control"  type="text"  wire:model.lazy="username"
                 autocomplete="off" placeholder="devvboy">
