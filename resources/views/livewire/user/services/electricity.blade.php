<div class="login-card">
    ...
    <form id="game" wire:submit.prevent="submit">
        ...
        <div class="form-group">
            ...
            <select id="inputNoncorehub" class="form-control select-option" wire:model.defer="type">
        ...
        <div class="form-group">
            <label for="inputNoncorehub">@lang('Provider')</label>
            <select id="inputNoncorehub" class="form-control select-option" wire:model="network">
                <option value="">@lang('Select One')</option>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1"> @lang('Meter Number')</label>
            <input class="input-field form-control"  type="number" step="1" wire:model.lazy="meter_number"
        ...
        <div class="form-group">
            ...
            <input class="input-field form-control" type="number" min="{{$service->min_limit}}" max="{{$service->max_limit}}" step="any" wire:model.defer="amount"
